...
const LoginUI = ({
  ...
  return (
    <View {...View1Props}>
      <Pressable
        {...button1Props}
        style={[styles.button1, { width: 200, height: 200 }]}>
...
const ProductListCardDesign = (props: IProductListCard) => (
  <Pressable {...props.btn1Props}>
...
const ProductList = (props: IProductList) => {
  return (
    <FlatList
      ...
      renderItem={
        props.flatlist1Props?.renderItem
          ? props.flatlist1Props.renderItem
          : ({ item, index }) =>
              index > 2 ? (
                <ProductListCardDesignWrapper btn1Props={{}} item={item} />
              ) : (
                <View key={index} />
              )
      }
